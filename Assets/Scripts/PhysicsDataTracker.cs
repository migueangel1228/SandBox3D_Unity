...
public class PhysicsDataTracker : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (textAcel != null) textAcel.text = "Acel Y: " + acel.y.ToString("F2") + " m/s²";
    }
